        ...
        {!isMobile && (
          <>
            ...
            <button
              ...
              style={{ left: isSidebarOpen ? 202 + "px" : 0 }}
            >
              {isSidebarOpen ? (
                <FeatherIcon icon="chevron-left" size="25" color="#fff" />
              ) : (
                <FeatherIcon icon="chevron-right" size="25" color="#fff" />
              )}
            </button>
          </>
        )}
        ...
        {isMobile && (
          <div className="modalWrap m">
            <MapModal
              ...
              moveLatLng={moveLatLng}
            />
            <button className="modalOpenBtn" onClick={onModalOpen}>
              리스트로 보기
            </button>
          </div>
        )}
